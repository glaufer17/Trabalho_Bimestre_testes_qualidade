...
public class Validador {
    ...
    /** 
    * esse método ignora entradas "" e aceita "Espaços em branco" no começo 
    * e no final da String o que pode causar uma variação em outros métodos
    * que utilizam de seu tamanho para fazer alguns calculos de verificação.
    */ 
    }
...
/*----------------------------------------------------------------------------*/
     ...
     */
    public static boolean cartaoValido(String numCartao) {
